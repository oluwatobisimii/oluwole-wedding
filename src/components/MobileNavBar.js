  ...
  return (
    <>
      ...
      {nav && <div className="fixed top-[12vh] z-[100000] h-[70vh] bg-white flex flex-col w-full text-2xl p-4 md:p-10 py-10  opacity-100 backdrop-blur-md font-Montaga uppercase gap-10 ">
        ...
        <a  href="#programme" target="_blank" rel="noopener noreferrer">Itinerary</a>
        <a  href="#our-story" target="_blank" rel="noopener noreferrer">our story</a>
         <a href="#rsvp" target="_blank" rel="noopener noreferrer">RSVP</a>
        <a href="#gallery" target="_blank" rel="noopener noreferrer">Gallery</a>
        <a href="#gifts" target="_blank" rel="noopener noreferrer">GIFTS</a>
      </div>}
    </>
  );
};
